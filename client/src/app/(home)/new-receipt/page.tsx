...
const NewReceipt = () => {
  const { base_url, showReceipt, setShowReceipt } = useContextData();
                  ...
                  >
                    <div>
                      ...
                      <input
                        type='text'
                        value={
                          tenants.find((t) => t._id === activeTenantId)?.name
                        }
                        readOnly
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          (tenants.find((t) => t._id === activeTenantId)
                            ?.rentedUnit.monthlyRent || 0) +
                          (tenants.find((t) => t._id === activeTenantId)
                            ?.rentedUnit.gasBill || 0) +
                          (tenants.find((t) => t._id === activeTenantId)
                            ?.rentedUnit.waterBill || 0) +
                          (tenants.find((t) => t._id === activeTenantId)
                            ?.rentedUnit.others || 0)
                        }
                        readOnly
